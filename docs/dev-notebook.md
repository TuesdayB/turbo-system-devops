...
- [x] Add background
- [x] Recolor nav bar
- [ ] Create Mongo doc for comic pages (page link, page no., date published, title, array of comments [username, body, date published])
- [ ] Create Mongo doc for announcements (username of publisher, date published, body)
- [ ] Create Mongo doc for users (username, hashed password)
